    ...
    <div class="container">
        <div class="menu-wrap d-flex align-items-center">
            ...
            <div class="top-social ml-auto flex space-x-2">
                ...
                <a wire:navigate href="{{ url('/admin') }}" class="rounded-full border border-gray-300 p-2 flex items-center justify-center w-9 h-9 hover:bg-gray-200 bg-white"><img src="{{ asset('assets/images/login.png') }}" alt="Login" data-turbo="false"></a>
            </div>
        </div>
    </div>
</header>