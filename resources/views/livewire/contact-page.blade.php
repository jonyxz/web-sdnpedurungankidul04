            ...
            <div class="row">
                ...
                <div class="bg-white p-3 p-md-5">
                    ...
                    <li class="d-block mb-3">
                        ...
                        <span>Jalan Blancir Raya RT 06 RW 12, Kecamatan Pedurungan, Kota Semarang, </span>
                    </li>
                    <li class="d-block mb-3"><span class="d-block text-black">Telepon:</span><span>+62 8139 0565 430</span></li>
                    <li class="d-block mb-3"><span class="d-block text-black">Email:</span><span>sdn.pedurungankidul.04@gmail.com</span></li>
                    </ul>
                </div>
                </div>
            </div>
